...
local Language_EN = {
    ...
    TICKET_SELECTEDPLAYER = "Selected player(s): ",
    ...
    TICKET_BUT_GOTO = "Goto",
    TICKET_BUT_TELEPORT = "Teleport",
    TICKET_BUT_SPECTATE = "Spectate",
    TICKET_BUT_FREEZE = "Freeze",
    TICKET_BUT_UNFREEZE = "Unfreeze",
    TICKET_BUT_MORE = "More",
    ...
    NOTIF_FREEZE = "You've been frozen by %s.",
...
local Language_FR = {
    ...
    TICKETSTATUS_TAKEN = "En cours",
    TICKETSTATUS_CLOSED = "Fermé",

    -- TICKETS POPUP --
    TICKET_CREATOR = "Créateur : ",
    TICKET_SUBJECT = "Objet : ",
    TICKET_DESCRIPTION = "Message : ",
    TICKET_SELECTEDPLAYER = "Joueurs sélectionnés : ",
    TICKET_ATTACHMENTS = "Pièces jointes : ",
    TICKET_TAKENBY = "Pris par : ",
    TICKET_DATE = "Date : ",
    TICKET_TIME = "Heure : ",

    -- TICKETS BUTTONS --
    TICKET_BUT_TAKE = "Prendre",
    TICKET_BUT_GOTO = "Goto",
    TICKET_BUT_TELEPORT = "Téléporter",
    TICKET_BUT_SPECTATE = "Regarder",
    TICKET_BUT_FREEZE = "Geler",
    TICKET_BUT_UNFREEZE = "Dégeler",
    TICKET_BUT_MORE = "Plus",
    ...
    NOTIF_FREEZE = "Vous avez été gelé par %s.",
